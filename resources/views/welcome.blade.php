@component('layouts.base', ['title' => 'Meddz'])
    <div class="-mt-20">
        <header class=" bg-gradient-to-b from-indigo-100 via-indigo-50 to-white pt-20">
                ...
                <div class="flex justify-around items-center px-8">
                    <div class="w-7/12 space-y-4">
                        ...
                        <p class="text-lg font-medium text-slate-600">
                            Dive into the comprehensive world of medicines available in Algeria with Meddz. Our
                            statistics
                            section offers a wealth of information designed to empower you with accurate and reliable
                            data.
